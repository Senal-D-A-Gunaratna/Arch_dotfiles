...
hl.bind(mainMod .. "+D", hl.dsp.exec_cmd("skwd-wall-v2"))
hl.bind(mainMod .. "+M", hl.dsp.exec_cmd(float_kitty .. " wiremix"))
hl.bind(mainMod .. "+N", hl.dsp.exec_cmd(float_kitty .. " impala"))
hl.bind(mainMod .. "+B", hl.dsp.exec_cmd(float_kitty .. " bluetui"))
hl.bind(mainMod .. "+I", hl.dsp.exec_cmd("kitty nvim"))
hl.bind(mainMod .. "+O", hl.dsp.exec_cmd("~/.config/scripts/toggle-sunset.sh"))
...
-- Fine volume control (hold Shift + up/down)
...
-- Shift + arrows for track control
