...
hl.bind(mainMod .. " + I", hl.dsp.exec_cmd("kitty -e --override window_padding_width=0 nvim"))
...
-- Continuous change volume
hl.bind("SHIFT + up", hl.dsp.exec_cmd("wpctl set-volume -l 1.0 @DEFAULT_AUDIO_SINK@ 1%+"), { repeating = true })
hl.bind("SHIFT + down", hl.dsp.exec_cmd("wpctl set-volume @DEFAULT_AUDIO_SINK@ 1%-"), { repeating = true })
...
hl.bind("Print", hl.dsp.exec_cmd("hyprshot -m output -m active -o " .. screenshotDir))
hl.bind(mainMod .. " + Print", hl.dsp.exec_cmd("hyprshot -m window -m active -o " .. screenshotDir))
hl.bind(mainMod .. " + SHIFT + Print", hl.dsp.exec_cmd("hyprshot -m region -o " .. screenshotDir))
